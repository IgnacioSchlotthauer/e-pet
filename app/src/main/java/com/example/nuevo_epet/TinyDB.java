...
public class TinyDB {
    ...
    public List<Alarma> getListAlarm(String key, Class<?> mClass){
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = getListString(key);
    	List<Alarma> alarmas =  new ArrayList<>();

    	for(String jObjString : objStrings){
    		Alarma value  = gson.fromJson(jObjString, (Type) mClass);
            alarmas.add(value);
    	}
    	return alarmas;
    }
...
//    }
    ...
    public void putListAlarm(String key, List<Alarma> objArray){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(Object obj : objArray){
