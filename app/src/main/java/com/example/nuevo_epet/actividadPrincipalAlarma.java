...
public class actividadPrincipalAlarma extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.setSpan(new ImageSpan(actividadPrincipalAlarma.this, R.drawable.ic_love), builder.length() - 1, builder.length(), 0);
